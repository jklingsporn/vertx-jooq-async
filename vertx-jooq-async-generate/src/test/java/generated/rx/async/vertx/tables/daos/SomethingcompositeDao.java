...
public class SomethingcompositeDao extends DAOImpl<SomethingcompositeRecord, generated.rx.async.vertx.tables.pojos.Somethingcomposite, Record2<Integer, Integer>> implements VertxDAO<generated.rx.async.vertx.tables.records.SomethingcompositeRecord,generated.rx.async.vertx.tables.pojos.Somethingcomposite,org.jooq.Record2<java.lang.Integer, java.lang.Integer>> {

    /**
     * Create a new SomethingcompositeDao without any configuration
     */
    public SomethingcompositeDao() {
        super(Somethingcomposite.SOMETHINGCOMPOSITE, generated.rx.async.vertx.tables.pojos.Somethingcomposite.class);
    }
    ...
    public SomethingcompositeDao(Configuration configuration) {
        super(Somethingcomposite.SOMETHINGCOMPOSITE, generated.rx.async.vertx.tables.pojos.Somethingcomposite.class, configuration);
    }
     ...
     */
    @Override
    protected Record2<Integer, Integer> getId(generated.rx.async.vertx.tables.pojos.Somethingcomposite object) {
     ...
     */
    public List<generated.rx.async.vertx.tables.pojos.Somethingcomposite> fetchBySomeid(Integer... values) {
     ...
     */
    public List<generated.rx.async.vertx.tables.pojos.Somethingcomposite> fetchBySomesecondid(Integer... values) {
     ...
     */
    public List<generated.rx.async.vertx.tables.pojos.Somethingcomposite> fetchBySomejsonobject(JsonObject... values) {
     ...
     */
    public Single<List<generated.rx.async.vertx.tables.pojos.Somethingcomposite>> fetchBySomeidAsync(List<Integer> values) {
     ...
     * Fetch records that have <code>someId IN (values)</code> asynchronously
     */
    public Observable<generated.rx.async.vertx.tables.pojos.Somethingcomposite> fetchBySomeidObservable(List<Integer> values) {
     ...
     */
    public Single<List<generated.rx.async.vertx.tables.pojos.Somethingcomposite>> fetchBySomesecondidAsync(List<Integer> values) {
     ...
     * Fetch records that have <code>someSecondId IN (values)</code> asynchronously
     */
    public Observable<generated.rx.async.vertx.tables.pojos.Somethingcomposite> fetchBySomesecondidObservable(List<Integer> values) {
     ...
     */
    public Single<List<generated.rx.async.vertx.tables.pojos.Somethingcomposite>> fetchBySomejsonobjectAsync(List<JsonObject> values) {
     ...
     * Fetch records that have <code>someJsonObject IN (values)</code> asynchronously
     */
    public Observable<generated.rx.async.vertx.tables.pojos.Somethingcomposite> fetchBySomejsonobjectObservable(List<JsonObject> values) {
    ...
    @Override
    public java.util.function.Function<io.vertx.core.json.JsonObject, generated.rx.async.vertx.tables.pojos.Somethingcomposite> jsonMapper() {
        return generated.rx.async.vertx.tables.pojos.Somethingcomposite::new;
    }
